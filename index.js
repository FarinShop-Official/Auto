...
🙏 *TERIMA KASIH!*
Terima kasih telah menggunakan layanan kami 💙
Kalau ada kendala, silakan hubungi support kapan saja 📞🤝
`;
    ...
    const keyboard = {
      inline_keyboard: [
        ...
        [{ text: "📊 CEK MONITOR REAL TIME", url: "https://t.me/calbacknotifikasi" }]
      ]
    };

    await bot.sendMessage(channellog, chNotif, { 
      parse_mode: "Markdown",
...
if (data === "profile") {
  ...
  let displayUsername = "@csfastcalotpbot"; // Request: Username User Biasa jadi @nist72
...
• 🆔 ID: \`${userId}\`
• 💰 Saldo Bot: ${saldoLocalFormat}

🌐 *Saldo Server (DepositOTP)*
• 💎 Saldo: ${saldoApiFormat}
• 📡 Status: ${apiStatus}
...
async function processSuccessfulDeposit(
  ...
  // 🎯 ID KHUSUS (BOS)
  const TARGET_NOTIF_ID = "7249549761"; 
...
_Saldo otomatis ditambahkan._
`;
        await bot.sendMessage(CHANNEL_ID, channelMsg, { parse_mode: "Markdown" });
      } catch (errChannel) {
...
──────────────────────────
✨ _Access Granted: Super Administrator_
`;
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  console.log(
    chalk.white("• Developer : ") + chalk.cyanBright("@gudel023")
  );
  console.log(
...
setInterval(checkPriceMonitor, 3 * 60 * 1000); 
